...
const Attendance = () => {
  ...
  const loadStudentsForClass = async () => {
    ...
    try {
      ...
      const existing = await getAttendanceByClassAndDate(selectedClass, selectedDate)
      ...
      if (existing) {
        ...
        toast('Attendance already recorded for this date — you can edit it.', { icon: 'ℹ️' })
      } else {
                  ...
                  {filteredHistory.map((record) => {
                    ...
                    return (
                      <tr key={record.id} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-5 py-4 text-gray-600">{record.class}</td>
                        ...
                        <td className="px-5 py-4">
                          <span className="text-red-500 font-semibold">{record.absentCount}</span>
                        </td>
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-xs font-semibold ${
                              rate >= 80 ? 'text-green-600' : rate >= 60 ? 'text-yellow-600' : 'text-red-500'
                            }`}>
                              {rate}%
                            </span>
                          </div>
