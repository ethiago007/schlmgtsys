...
const EditStudent = () => {
  ...
  const ageBanner = ageValidation && {
    valid: {
      ...
      icon: isSpecialCase ? <MdWarning size={18} /> : <MdCheckCircle size={18} />,
    },
    invalid: {
    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="text-sm font-medium text-blue-700">Class Age Brackets</p>
          ...
          <AnimatePresence>
            {ageValidation && (
              ...
              >
                ...
                <p className={`text-sm ${ageBanner.text}`}>{ageValidation.message}</p>
              </motion.div>
            )}
          </AnimatePresence>
