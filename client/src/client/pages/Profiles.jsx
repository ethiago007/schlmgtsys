...
const Profile = () => {
  ...
  const details = [
    ...
    { icon: <MdLocationOn size={18} />, label: 'Address',       value: student.address },
    { icon: <MdSchool size={18} />,     label: 'Class',         value: student.class },
    { icon: <MdPerson size={18} />,     label: 'Gender',        value: student.gender },
    { icon: <MdCake size={18} />,       label: 'Date of Birth', value: student.dateOfBirth },
  ]
