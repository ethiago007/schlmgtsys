...
import { gradeColor, terms } from '../../utils/constants'
...
const TeacherGrades = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {loading ? (
          <div className="p-10 text-center text-gray-400 text-sm">Loading grades...</div>
        ) : filtered.length === 0 ? (
          <div className="p-10 text-center text-gray-400 text-sm">
            {search || termFilter ? 'No grades match your filters.' : 'No grades recorded yet.'}
          </div>
        ) : (
              ...
              <tbody className="divide-y divide-gray-100">
                {filtered.map((g, index) => (
                  <tr key={g.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4 text-gray-600">{g.studentClass}</td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => navigate(`/teacher/grades/edit/${g.id}`)}
