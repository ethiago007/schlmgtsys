...
export const emailApi = {
  sendGradeNotification: (data) =>
    api.post("/api/email/grade-notification", data),

  sendMessageNotification: (data) =>
    api.post("/api/email/message-notification", data),

  sendFeeReminders: () => api.post("/api/email/fee-reminders", {}),

  sendAnnouncement: (data) => api.post("/api/email/announcement", data),

  sendWelcome: (data) => api.post("/api/email/welcome", data),
};
